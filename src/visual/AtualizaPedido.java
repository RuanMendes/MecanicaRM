 ...
 * @author Alunos
 */
public class AtualizaPedido extends javax.swing.JInternalFrame {

    /**
     * Creates new form AtualizaPedido
     */
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Atualiza Pedido");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(campoData, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(campoPlaca, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
...
PedidoService pService = new PedidoService();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Calendar dataEntrada = campoData.getCalendar();
        String tipoServico = campoServico.getText();
        String valor = campoValor.getText();
        String placa = campoPlaca.getText();
        String id = campoId.getText();
        if (pService.verificaCamposId(dataEntrada, tipoServico, valor, placa, id)) {
            JOptionPane.showMessageDialog(this, "1 ou mais campos estão invalidos");
        } else {
            System.out.println(valor.replace(",","."));
            Boolean atualizadoComSucesso = pService.updateCliente(dataEntrada, tipoServico, Double.parseDouble(valor.replace(",",".")), placa, Long.parseLong(id));
